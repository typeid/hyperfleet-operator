...
manifests: controller-gen ## Generate CRD manifests.
	...
	cp config/crd/bases/*.yaml charts/hyperfleet-operator/crds/
...
test-integration: manifests generate fmt vet ## Run integration tests (requires Postgres + DynamoDB Local containers).
